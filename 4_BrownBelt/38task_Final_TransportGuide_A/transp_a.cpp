...
namespace {
const int EARTH_RADIUS = 6'371'000;  // meters
...
private:
	...
	double computeRouteLength(const string& routeNumber) {
...
void processRequests(BusManager& manager, istream& inStream = cin, ostream& outStream = cout) {
...
void testBuildRoute() {
	string str = "Bus 256: Biryulyovo Zapadnoye > Biryusinka > Universam > Biryulyovo "
